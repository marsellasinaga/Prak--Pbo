class Komputer:
    def _init_(self, merk, jenis, harga) -> None:
        self.jenis = jenis
        self.harga = harga
        self.merk = merk
...
class Processor(Komputer):
    def _init_(self, merk, jenis, harga, jumlah_core, kecepatan_processor) -> None:
        Komputer._init_(self, merk, jenis, harga)
        self.nama = "Processor"
        self.jumlah_core = jumlah_core
        self.kecepatan_processor = kecepatan_processor

class RAM(Komputer):
    def _init_(self, merk, jenis, harga, kapasitas) -> None:
        Komputer._init_(self, merk, jenis, harga)
        self.nama = "RAM"
        self.kapasitas = kapasitas

class HDD(Komputer):
    def _init_(self, merk, jenis, harga, kapasitas, rpm) -> None:
        Komputer._init_(self, merk, jenis, harga)
        self.nama = "SATA"
        self.kapasitas = kapasitas
        self.rpm = rpm
...
class PSU(Komputer):
    def _init_(self, merk, jenis, harga, daya) -> None:
        Komputer._init_(self, merk, jenis, harga)
        self.nama = "PSU"
        self.daya = daya
