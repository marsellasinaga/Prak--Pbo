class Robot:
    ...
    def _init_(self, nama, health, damage) -> None:
        self.nama = nama
        self.health = health
        self.damage = damage
        self.tangan_robot = 0
...
class Antares(Robot) :
    def _init_(self, nama  = "Antares", health = 50000, damage = 5000) -> None:
        super()._init_(nama, health, damage)
...
class Alphasetia(Robot) :
    def _init_(self, nama = "Alphasetia", health = 40000, damage = 6000) -> None:
        super()._init_(nama, health, damage)
...
class Lecalicus(Robot) :
    def _init_(self, nama = "Lecalicus", health = 450000, damage = 5500) -> None:
        super()._init_(nama, health, damage)
